...
import sovietPosterArt.utils.MathUtils;

public class PanScaleProxyView extends ImageView {
    ...
    private void constrainViewport() {
        if (mRelativeAspectRatio > 1) {
            ...
            float centerX = MathUtils.constrain(halfWidth, 1 - halfWidth,
            ...
            float centerY = MathUtils.constrain(halfHeight, 1 - halfHeight,
